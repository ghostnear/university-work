...
public class WhileStatement implements IStatement {
    ...
    public Dictionary<String, IType> typeCheck(Dictionary<String, IType> typeEnvironment) throws InterpreterException {
        ...
        if(!(type instanceof BooleanType))
            throw new CheckingException("WhileStatement: Condition is not a boolean!");

        this.blockCode.typeCheck(typeEnvironment.clone());
        this.nextStatement.typeCheck(typeEnvironment.clone());
