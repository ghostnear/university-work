...
void testSpecialOperation()
{
    printf("Test special operation.\n");
    ...
    assert(b.removeOccurences(3, 5) == 3);
    assert(b.nrOccurrences(5) == 2);

    assert(b.removeOccurences(5, 5) == 2);
    assert(b.nrOccurrences(5) == 0);
}
