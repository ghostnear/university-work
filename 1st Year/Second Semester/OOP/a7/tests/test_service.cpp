...
int test_service()
{
    ...
    Service service(repository, users, ExportType::Memory);
    ...
    catch(const CustomException&){ } // Add already existing event.
    ...
    catch(const CustomException&){ } // Update non existing event.
    ...
    catch(const CustomException&){ } // Remove non existing event.
